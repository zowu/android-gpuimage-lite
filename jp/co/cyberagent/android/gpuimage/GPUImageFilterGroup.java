...
public class GPUImageFilterGroup extends GPUImageFilter {
     ...
     */
    public GPUImageFilterGroup(@Nullable List<GPUImageFilter> filters) {
        mFilters = filters;
        if (mFilters == null) {
    ...
    public void addFilter(@Nullable GPUImageFilter aFilter) {
        if (aFilter == null) {
            return;
        }
    ...
    /*
     * (non-Javadoc)
     * @see jp.co.cyberagent.android.jp.co.cyberagent.android.gpuimage.GPUImageFilter#onInit()
     */
    @Override
    public void onInit() {
        super.onInit();
    ...
    /*
     * (non-Javadoc)
     * @see jp.co.cyberagent.android.jp.co.cyberagent.android.gpuimage.GPUImageFilter#onDestroy()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * jp.co.cyberagent.android.jp.co.cyberagent.android.gpuimage.GPUImageFilter#onOutputSizeChanged(int,
     * int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see jp.co.cyberagent.android.jp.co.cyberagent.android.gpuimage.GPUImageFilter#onDraw(int,
     * java.nio.FloatBuffer, java.nio.FloatBuffer)
     */
    @SuppressLint("WrongCall")
    @Override
    public void onDraw(final int textureId,
                       @NonNull final FloatBuffer cubeBuffer,
                       @NonNull final FloatBuffer textureBuffer) {
